    ...
    private var kidsProfileiPhone: some View {
        VStack(spacing: 0) {
            ...
            Image("mascot_empty")
                ...
                .clipped()
                .padding(.bottom, 16)
            Text(NSLocalizedString("kids_profile_title", tableName: nil, bundle: Bundle.main, value: "", comment: ""))
            ...
            Text(NSLocalizedString("kids_profile_subtitle", tableName: nil, bundle: Bundle.main, value: "", comment: ""))
